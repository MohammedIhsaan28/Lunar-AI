...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#121821] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${
    ...
    >
      <div>
        ...
        >
          ...
          {expand ? (
            <h2 className="text-white text-2xl font-bold w-36">Lunar</h2>
          ) : (
            <Image
              className="w-10"
